...
namespace MovieAppDiplom.Droid
{
    ...
    public class LinkerPleaseInclude
    {
        ...
        public void Include(SearchView searchView)
        {
            ...
            searchView.Visibility = ViewStates.Invisible;
            searchView.Visibility = searchView.Visibility + 1;
            searchView.QueryTextChange += (sender, args) => searchView.SetQuery(searchView.Query, true);
        }
